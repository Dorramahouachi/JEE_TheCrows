...
public class EvaluationBean implements Serializable {
	...
	private Userz manager;
	private Userz employe;
	...
	public Userz getEmploye() {
		return employe;
	}

	public void setEmploye(Userz employe) {
		this.employe = employe;
	}
	

	public Userz getManager() {
		return manager;
	}

	public void setManager(Userz manager) {
		this.manager = manager;
	}

	public List<Userz> getUsers() {
		return userService.getUsesDistinctFromLoggedUser(loginBean.getLoggedUser().getId());
	}

	public void setUsers(List<Userz> users) {
		this.users = users;
	}
